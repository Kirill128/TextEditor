...
namespace ParserWithList
{
    public class Page
    {
        ...
        public static LinkedList<WordBox> getUniqueWordsBoxes(Page p)
        {
            LinkedList<WordBox> mainBoxes = p.Lines.First.Value.getUniqueWordsBoxes();

            LinkedList<WordBox> newWords;
            for (LinkedListNode<Line> line = p.Lines.First.Next; line != null; line = line.Next)
            {
                LinkedList<WordBox> lineBoxes = line.Value.getUniqueWordsBoxes();
                newWords = new LinkedList<WordBox>();
